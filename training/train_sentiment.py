...
OUTPUT_DIR = ROOT_DIR / "models" / "fine_tuned" / "sentiment_model"
...
def train(args: argparse.Namespace) -> None:
    ...
    label2id, id2label = build_label_map(train_df["sentiment"])
    ...
    print(f"Saved fine-tuned sentiment model to {args.output_dir}")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fine-tune a sentiment classification model.")
    parser.add_argument(
        "--model-name",
        type=str,
